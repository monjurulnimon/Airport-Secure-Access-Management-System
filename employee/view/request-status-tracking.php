...
<nav>
    <ul class="sidebar-menu">
        ...
        <li><a href="#status" class="menu-item"> Request Status Tracking</a></li>
  ...
  <table class="fancy-table">
    ...
    <tbody>
      <?php foreach($requests as $r){
        ...
        <td>";
        if($r['status']=='Pending'){
            echo "<a href='?cancel_id={$r['id']}' class='action-link'>Cancel</a>";
        } else { echo "-"; }
        echo "</td></tr>";
      } ?>
    </tbody>
...
.card {
  ...
  padding: 25px 20px;
  border-radius: 20px;
  box-shadow: 0 8px 20px rgba(17, 6, 110, 0.08);
  max-width: 95%;
  margin: 30px auto;
